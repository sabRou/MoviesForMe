    ...
    return (
      <View style={styles.main_container}>
        ...
        <FlatList
          ...
          renderItem={({item}) => <FilmItem film={item} isFavoriteFilm={(this.props.favoritesFilm.findIndex(film => film.id === item.id) !== -1) ? true : false} displayDetailForFilm={this._displayDetailForFilm}/>}
